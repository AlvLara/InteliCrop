...
RABBITMQ_USER = os.getenv("RABBITMQ_USER_PYTHON")
RABBITMQ_PASS = os.getenv("RABBITMQ_PASS_PYTHON")
...
def procesar_mensaje(channel, method, properties, body):
    try:
        ...
        mongo_repo.guardar_lectura_raw(lectura)
...
if __name__ == "__main__":
    if not mongo_repo.health_check():
